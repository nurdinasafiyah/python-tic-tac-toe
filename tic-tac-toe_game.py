...
# check for wrong input, should return True or False.
# True denoting that the user input is correct
# checking for wrong input (user is entering invalid position) or position is out of bound
...
# a logic to check if the previous winner just win
...
# a function to check if the game board is already full
